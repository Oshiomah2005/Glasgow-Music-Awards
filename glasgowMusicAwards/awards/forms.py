...
class AddArtistForm(forms.ModelForm):
    ...
    songLink = forms.URLField(max_length=200, help_text=mark_safe("<br>Please enter the /embed/ url of their most popular song (note: this must be an embeded YouTube link!)"))
